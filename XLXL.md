...
- **Deadline Management**: A global file named `xlxl-reminder.md` must be maintained in the standards repository to track critical time-sensitive deadlines and recurring events.
