...
- **Centralized Tasks**: All task-specific directories must be created under `~/tasks/`.
...
1. **Task Directory Creation**: At the beginning of each session, a dedicated folder must be created inside `~/tasks/`. The folder name should represent the session's primary objective (e.g., `~/tasks/2024-04-15-tmux-setup`).
